...
# print(data4['instruments'].value_counts())

# # Slice so that they only have the lowest value count of a class
# data_temp = data4[data4["instruments"] == "cel"][:1163]
# for i in concat_list:
# 	data_t = data4[data4["instruments"] == i][:1163]
# 	data_temp = pd.concat([data_temp, data_t], ignore_index=True)
